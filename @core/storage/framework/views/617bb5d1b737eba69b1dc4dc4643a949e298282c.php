$('a#tag_view_all').hide();
    $(document).on('keyup','#search',function (e){
        ...
        $.ajax({
            type: 'get',
            url :  "<?php echo e(route('frontend.blog.autocomplete.search')); ?>",
            data: {
                query: $(this).val()
            },
            beforeSend: function (){
...
<?php /**PATH F:\Server\htdocs\katerio\@core\resources\views/components/frontend/blog-search.blade.php ENDPATH**/ ?>
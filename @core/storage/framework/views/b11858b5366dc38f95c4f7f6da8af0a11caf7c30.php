                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.general.scripts.settings')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="enable_facebook_login"><strong><?php echo e(__('Enable/Disable Google Add')); ?></strong></label>
                                <label class="switch">
                                    <input type="checkbox" name="enable_google_adsense"  <?php if(!empty(get_static_option('enable_google_adsense'))): ?> checked <?php endif; ?> >
                            ...
                            <p class="info-text"><?php echo e(__('follow doc for Google Adsence Publisher ID and Customer ID')); ?> 
                             ...
                             <p class="info-text"><?php echo e(__('follow doc for instagram token')); ?> <code><?php echo e(url('/')); ?>/google/callback</code>

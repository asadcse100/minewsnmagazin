                             ...
                             <div class="card-body">
                                 ...
                                 <div class="table-wrap table-responsive">
                                     <table class="table table-default" id="all_blog_table">
                                         ...
                                         <tbody>
                                         <?php $__currentLoopData = $all_auth_user_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                             <tr>
...
<?php endif; ?>
                                                 ...
                                                 <td>
                                                     <a class="btn btn-primary btn-xs mb-3 mr-1" href="<?php echo e(route('user.blog.edit',$data->id).'?lang='.$user_select_lang_slug); ?>">

...
<head>
   ...
   <?php if(!empty(get_static_option('site_google_analytics'))): ?>
    ...
    <?php echo load_google_fonts(); ?>
        ...
        <link rel="preload" href="<?php echo e(asset('assets/frontend/fonts/la-brands-400.woff2')); ?>" as="font" type="font/woff2" crossorigin> 
        <link rel="preload" href="<?php echo e(asset('assets/frontend/fonts/la-solid-900.woff2')); ?>" as="font" type="font/woff2" crossorigin> 
        <link rel="preload" href="<?php echo e(asset('assets/frontend/fonts/la-regular-400.woff2')); ?>" as="font" type="font/woff2" crossorigin> 
   ...
   <?php endif; ?>
    ...
    <script rel="preload" src="<?php echo e(asset('assets/common/js/jquery-3.6.0.min.js')); ?>"></script>
    <script rel="preload" src="<?php echo e(asset('assets/common/js/jquery-migrate-3.3.2.min.js')); ?>"></script>
...
<?php /**PATH F:\Server\htdocs\katerio\@core\resources\views/frontend/partials/header.blade.php ENDPATH**/ ?>
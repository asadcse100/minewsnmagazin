        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="blog-details-inner-area">
                    ...
                    <?php if(!empty($blog_post->comment_status)): ?>
                   ...
                   // el.text('<?php echo e(__('Submitting')); ?>...');
                    ...
                    $.ajax({
                        ...
                        success: function (data){
                            ...
                            let blog_comment_approve_status = '<?php echo e($blog_post->comment_approve_status); ?>';

                            if(blog_comment_approve_status == 0){
                                toastr.error('Please wait for approving your comment by administration');
                                setTimeout(function(){
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Server\htdocs\katerio\@core\Modules/Blog\Resources/views/frontend/blog/blog-single-variant/details-01.blade.php ENDPATH**/ ?>
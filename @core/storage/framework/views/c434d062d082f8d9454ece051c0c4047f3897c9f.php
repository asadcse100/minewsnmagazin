                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.profile.update')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  id="facebook_url" name="facebook_url" value="<?php echo e(auth()->user()->facebook_url); ?>">
                            </div>

                            <div class="form-group">
                                <label for="email"><?php echo e(__('Twitter URL')); ?></label>
                                <input type="text" class="form-control"  id="twitter_url" name="twitter_url" value="<?php echo e(auth()->user()->twitter_url); ?>">
                            </div>

                            <div class="form-group">
                                <label for="email"><?php echo e(__('Instagram URL')); ?></label>
                                <input type="text" class="form-control"  id="instagram_url" name="instagram_url" value="<?php echo e(auth()->user()->instagram_url); ?>">
                            </div>

                            <div class="form-group">
                                <label for="email"><?php echo e(__('Linkedin URL')); ?></label>
                                <input type="text" class="form-control"  id="linkedin_url" name="linkedin_url" value="<?php echo e(auth()->user()->linkedin_url); ?>">
                            </div>

                    ...
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            <div class="left-content">
                                <h4 class="header-title"><?php echo e(__('All Advertisements')); ?>  </h4>
...
<?php endif; ?>
                            ...
                            <div class="right-content">
                                <a href="<?php echo e(route('admin.advertisement.new')); ?>" class="btn btn-primary"><?php echo e(__('Add New Advertisement')); ?></a>
                            </div>
                             <?php endif; ?>
                        </div>
...
<?php endif; ?>
                                            ...
                                            <td>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('advertisement-delete')): ?>
                                                  <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.delete-popover','data' => ['url' => route('admin.advertisement.delete',$data->id)]]); ?>
...
<?php endif; ?>
                                                <?php endif; ?>
                                                  ...
                                                  <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.edit-icon','data' => ['url' => route('admin.advertisement.edit',$data->id)]]); ?>
    ...
    <script type="text/javascript">
        (function(){
            ...
            $(document).ready(function(){
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.bulk-action-js','data' => ['url' => route('admin.advertisement.bulk.action')]]); ?>

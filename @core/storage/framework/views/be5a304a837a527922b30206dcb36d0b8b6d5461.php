...
<div class="page-container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-6 clearfix">
                    <div class="user-profile pull-right">
                        <?php echo render_image_markup_by_attachment_id(auth()->guard('admin')->user()->image,'avatar user-thumb','','',false); ?>
    ...
    <footer>
        <div class="footer-area footer-wrap">
            ...
            <p class="version">V-<?php echo e(get_static_option('site_script_version','1.0.7')); ?></p>
        </div>
    </footer>
</div>
...
<?php /**PATH F:\Server\htdocs\katerio\@core\resources\views/backend/admin-master.blade.php ENDPATH**/ ?>
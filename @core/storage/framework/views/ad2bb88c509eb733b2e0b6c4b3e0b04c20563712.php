...
<div class="form-group">
    <?php if(isset($label)): ?><label for="edit_language text-primary"><?php echo e(__('Languages')); ?></label> <?php endif; ?>
...
<?php /**PATH F:\Server\htdocs\newsnmagazin\@core\resources\views/components/lang/frontend-lang-select.blade.php ENDPATH**/ ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="header-title pull-right">
                            <div class="btn-wrapper-inner">
                                <form action="<?php echo e(route('admin.faq')); ?>" method="get" id="langauge_change_select_get_form">
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
                                ...
                                <?php $__currentLoopData = $all_faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($data->id); ?></td>
                                          <?php $open = $data->is_open == 'on' ?  "<span class='badge badge-primary'> Open </span>" : '';  ?>
                                            <td><?php echo e($data->getTranslation('title',$default_lang)); ?> <?php echo $open; ?>  </td>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Server\htdocs\katerio\@core\resources\views/backend/pages/faqs.blade.php ENDPATH**/ ?>
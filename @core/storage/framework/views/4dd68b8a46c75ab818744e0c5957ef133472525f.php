...
//Poll Voting Store
        $(document).on('click', '#submit_vote_btn', function (e) {
            ...
            let route = "<?php echo e(route('frontend.poll.vote.store')); ?>";
            ...
            $.ajax({
                ...
                error: function (data) {
                    ...
                    el.text('<?php echo e(__("Submit Vote")); ?>');
                }
            });
        })
    });
...
<?php /**PATH F:\Server\htdocs\katerio\@core\resources\views/components/frontend/poll-voting.blade.php ENDPATH**/ ?>
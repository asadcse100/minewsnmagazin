                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.general.typography.settings')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="heading_font"><?php echo e(__('Heading Font One')); ?></label>
                                <label class="switch">
                            ...
                            <label for="heading_font" class="mt-4"><?php echo e(__('Heading Font Two')); ?></label>
                            <div class="form-group">
                                <label for="heading_font_family "><?php echo e(__('Font Family')); ?></label>
                                <select class="form-control nice-select wide" name="heading_font_family_two" id="heading_font_family_two">
                                    <?php $__currentLoopData = $google_fonts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $font_family => $font_variant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($font_family); ?>" <?php if($font_family == get_static_option('heading_font_family_two')): ?> selected <?php endif; ?>><?php echo e($font_family); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group margin-top-50">
                                ...
                                <select class="form-control nice-select wide" multiple name="heading_font_variant_two[]" id="heading_font_variant_two">
                                    <?php $__currentLoopData = $get_font_family_variants_2['variants']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php

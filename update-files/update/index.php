                    ...
                    <form id="msform" action="index.php" method="post">
                        ...
                        <div class="content-wrap with-step">
                            ...
                            <div class="hidden-update-wrap">
                                ...
                                <div class="check-db-connection" >
                                    <h2>Update Migration Files</h2>
                                    <div class="right-wrap">
                                        <button class="boxed-btn file_update_button" type="button" data-action="updated_migration_file" >Update</button>
                                    </div>
                                </div>
                                <div class="check-db-connection">
                                ...
                                <!-- <div class="check-db-connection">
                                    <h2>Update Seeders Files</h2>
                                    <div class="right-wrap">
                                        <button class="boxed-btn file_update_button" type="button" data-action="update_seeds_file">Update</button>
                                    </div>
                                </div> -->
                                <div class="check-db-connection">
                                    <h2>Update Assets</h2>
